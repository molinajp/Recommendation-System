...
public class Movie {
    ...
    public Movie (String anID, String aTitle, String aYear,
                  String aCountry,String theGenres,String aDirector,
    ...
    public String toString () {
        String result = "Movie [id=" + id + ", title=" + title +
        ", year=" + year; result += ", genres= " + genres + "]";
        return result;
    }
}
